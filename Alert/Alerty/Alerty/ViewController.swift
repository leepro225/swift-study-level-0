...
//  Alerty
//
//  Created by hrobotics on 2020/04/09.
...
class ViewController: UIViewController {
    ...
    @IBAction func btnLampRemove(_ sender: UIButton) {
        let lampRemoveAlert = UIAlertController(title: "램프 제거", message: "제거하시겠습니까?", preferredStyle: UIAlertController.Style.alert)
        ...
        let onAction = UIAlertAction(title: "아니로,켭니다", style: UIAlertAction.Style.default, handler: {ACTION in self.lampImg.image = self.imgOn
            self.isLampOn=true
        })
